...
class HoSoCaNhanMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./ho_so_ca_nhan.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./ho_so_ca_nhan.policy').acl);
  }


  async default (req, res, next) {

    console.log('HoSoCaNhan middleware;')
...
module.exports = HoSoCaNhanMiddleware;