...
class HopDongMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./hop_dong.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./hop_dong.policy').acl);
  }


  async default (req, res, next) {

    console.log('HopDong middleware;')
...
module.exports = HopDongMiddleware;