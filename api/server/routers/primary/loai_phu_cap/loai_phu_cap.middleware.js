...
class LoaiPhuCapMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./loai_phu_cap.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./loai_phu_cap.policy').acl);
  }


  async default (req, res, next) {

    console.log('LoaiPhuCap middleware;')
...
module.exports = LoaiPhuCapMiddleware;