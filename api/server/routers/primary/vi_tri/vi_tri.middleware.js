...
class ViTriMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./vi_tri.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./vi_tri.policy').acl);
  }


  async default (req, res, next) {

    console.log('ViTri middleware;')
...
module.exports = ViTriMiddleware;