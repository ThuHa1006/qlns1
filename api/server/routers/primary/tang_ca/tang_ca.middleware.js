...
class TangCaMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./tang_ca.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./tang_ca.policy').acl);
  }


  async default (req, res, next) {

    console.log('TangCa middleware;')
...
module.exports = TangCaMiddleware;