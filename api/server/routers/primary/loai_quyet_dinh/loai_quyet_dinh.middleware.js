...
class LoaiQuyetDinhMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./loai_quyet_dinh.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./loai_quyet_dinh.policy').acl);
  }


  async default (req, res, next) {

    console.log('LoaiQuyetDinh middleware;')
...
module.exports = LoaiQuyetDinhMiddleware;