...
class NhanVienMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./nhan_vien.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./nhan_vien.policy').acl);
  }


  async default (req, res, next) {

    console.log('NhanVien middleware;')
