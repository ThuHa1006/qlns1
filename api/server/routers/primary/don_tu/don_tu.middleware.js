...
class DonTuMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./don_tu.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./don_tu.policy').acl);
  }


  async default (req, res, next) {

    console.log('DonTu middleware;')
...
module.exports = DonTuMiddleware;