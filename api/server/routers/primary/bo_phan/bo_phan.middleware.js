...
class BoPhanMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./bo_phan.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./bo_phan.policy').acl);
  }


  async default (req, res, next) {

    console.log('BoPhan middleware;')
...
module.exports = BoPhanMiddleware;