...
class LoaiHopDongMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./loai_hop_dong.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./loai_hop_dong.policy').acl);
  }


  async default (req, res, next) {

    console.log('LoaiHopDong middleware;')
...
module.exports = LoaiHopDongMiddleware;