...
class PhieuDanhGiaMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./phieu_danh_gia.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./phieu_danh_gia.policy').acl);
  }


  async default (req, res, next) {

    console.log('PhieuDanhGia middleware;')
...
module.exports = PhieuDanhGiaMiddleware;