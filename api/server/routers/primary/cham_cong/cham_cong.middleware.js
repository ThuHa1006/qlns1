...
class ChamCongMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./cham_cong.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./cham_cong.policy').acl);
  }


  async default (req, res, next) {

    console.log('ChamCong middleware;')
...
module.exports = ChamCongMiddleware;