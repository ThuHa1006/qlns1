...
class PhieuLuongMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./phieu_luong.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./phieu_luong.policy').acl);
  }


  async default (req, res, next) {

    console.log('PhieuLuong middleware;')
...
module.exports = PhieuLuongMiddleware;