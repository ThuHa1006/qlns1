...
class NghiPhepMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./nghi_phep.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./nghi_phep.policy').acl);
  }


  async default (req, res, next) {

    console.log('NghiPhep middleware;')
...
module.exports = NghiPhepMiddleware;