...
class GiayToMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./giay_to.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./giay_to.policy').acl);
  }


  async default (req, res, next) {

    console.log('GiayTo middleware;')
...
module.exports = GiayToMiddleware;