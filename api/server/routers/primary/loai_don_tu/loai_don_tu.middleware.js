...
class LoaiDonTuMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./loai_don_tu.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./loai_don_tu.policy').acl);
  }


  async default (req, res, next) {

    console.log('LoaiDonTu middleware;')
...
module.exports = LoaiDonTuMiddleware;