...
class CapBacMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./cap_bac.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./cap_bac.policy').acl);
  }


  async default (req, res, next) {

    console.log('CapBac middleware;')
...
module.exports = CapBacMiddleware;