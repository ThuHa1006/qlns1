...
class ChinhSachMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./chinh_sach.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./chinh_sach.policy').acl);
  }


  async default (req, res, next) {

    console.log('ChinhSach middleware;')
...
module.exports = ChinhSachMiddleware;