...
class PhuCapMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./phu_cap.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./phu_cap.policy').acl);
  }


  async default (req, res, next) {

    console.log('PhuCap middleware;')
...
module.exports = PhuCapMiddleware;