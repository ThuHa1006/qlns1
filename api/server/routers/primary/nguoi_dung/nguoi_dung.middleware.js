...
class NguoiDungMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./nguoi_dung.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./nguoi_dung.policy').acl);
  }


  async default (req, res, next) {

    console.log('NguoiDung middleware;')
...
module.exports = NguoiDungMiddleware;