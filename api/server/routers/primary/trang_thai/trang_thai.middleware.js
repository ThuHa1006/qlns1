...
class TrangThaiMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./trang_thai.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./trang_thai.policy').acl);
  }


  async default (req, res, next) {

    console.log('TrangThai middleware;')
...
module.exports = TrangThaiMiddleware;