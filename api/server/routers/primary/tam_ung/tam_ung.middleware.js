...
class TamUngMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./tam_ung.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./tam_ung.policy').acl);
  }


  async default (req, res, next) {

    console.log('TamUng middleware;')
...
module.exports = TamUngMiddleware;