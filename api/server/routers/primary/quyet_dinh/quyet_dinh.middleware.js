...
class QuyetDinhMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./quyet_dinh.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./quyet_dinh.policy').acl);
  }


  async default (req, res, next) {

    console.log('QuyetDinh middleware;')
...
module.exports = QuyetDinhMiddleware;