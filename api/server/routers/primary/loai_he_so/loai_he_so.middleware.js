...
class LoaiHeSoMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./loai_he_so.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./loai_he_so.policy').acl);
  }


  async default (req, res, next) {

    console.log('LoaiHeSo middleware;')
...
module.exports = LoaiHeSoMiddleware;