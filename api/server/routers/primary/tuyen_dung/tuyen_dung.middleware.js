...
class TuyenDungMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./tuyen_dung.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./tuyen_dung.policy').acl);
  }


  async default (req, res, next) {

    console.log('TuyenDung middleware;')
...
module.exports = TuyenDungMiddleware;