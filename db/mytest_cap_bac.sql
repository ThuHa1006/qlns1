...
--
-- Table structure for table `cap_bac`
--
...
--
-- Dumping data for table `cap_bac`
--

LOCK TABLES `cap_bac` WRITE;
/*!40000 ALTER TABLE `cap_bac` DISABLE KEYS */;
/*!40000 ALTER TABLE `cap_bac` ENABLE KEYS */;
UNLOCK TABLES;
