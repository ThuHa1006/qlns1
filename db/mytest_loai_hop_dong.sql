...
DROP TABLE IF EXISTS `loai_hop_dong`;
...
LOCK TABLES `loai_hop_dong` WRITE;
/*!40000 ALTER TABLE `loai_hop_dong` DISABLE KEYS */;
/*!40000 ALTER TABLE `loai_hop_dong` ENABLE KEYS */;
UNLOCK TABLES;
