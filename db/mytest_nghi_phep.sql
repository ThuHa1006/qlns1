...
CREATE TABLE `nghi_phep` (
  ...
  `tong_huong` int DEFAULT NULL,
  `ngay` date DEFAULT NULL,
  `tinh_cong` tinyint(1) DEFAULT NULL,
  `ly_do` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
-- Dump completed on 2020-11-19 20:32:49
